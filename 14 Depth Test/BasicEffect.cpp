...
bool BasicEffect::InitAll(ComPtr<ID3D11Device> device)
{
	...
	// 创建顶点着色器(2D)
	HR(CreateShaderFromFile(L"HLSL\\Basic_VS_2D.vso", L"HLSL\\Basic_VS_2D.hlsl", "VS", "vs_5_0", blob.GetAddressOf()));
...
void BasicEffect::SetDrawBoltAnimNoDepthTest(ComPtr<ID3D11DeviceContext> deviceContext)
{
	deviceContext->IASetInputLayout(pImpl->vertexLayout3D.Get());
	deviceContext->VSSetShader(pImpl->vertexShader3D.Get(), nullptr, 0);
	deviceContext->RSSetState(RenderStates::RSNoCull.Get());
...
void BasicEffect::SetDrawBoltAnimNoDepthWrite(ComPtr<ID3D11DeviceContext> deviceContext)
{
	deviceContext->IASetInputLayout(pImpl->vertexLayout3D.Get());
	deviceContext->VSSetShader(pImpl->vertexShader3D.Get(), nullptr, 0);
	deviceContext->RSSetState(RenderStates::RSNoCull.Get());
...
void BasicEffect::SetDrawBoltAnimNoDepthTestWithStencil(ComPtr<ID3D11DeviceContext> deviceContext, UINT stencilRef)
{
	deviceContext->IASetInputLayout(pImpl->vertexLayout3D.Get());
	deviceContext->VSSetShader(pImpl->vertexShader3D.Get(), nullptr, 0);
	deviceContext->RSSetState(RenderStates::RSNoCull.Get());
...
void BasicEffect::SetDrawBoltAnimNoDepthWriteWithStencil(ComPtr<ID3D11DeviceContext> deviceContext, UINT stencilRef)
{
	deviceContext->IASetInputLayout(pImpl->vertexLayout3D.Get());
	deviceContext->VSSetShader(pImpl->vertexShader3D.Get(), nullptr, 0);
	deviceContext->RSSetState(RenderStates::RSNoCull.Get());
