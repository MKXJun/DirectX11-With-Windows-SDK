...
private:
	...
	Microsoft::WRL::ComPtr<ID2D1SolidColorBrush> mColorBrush;	// 单色笔刷
	Microsoft::WRL::ComPtr<IDWriteFont> mFont;					// 字体
	Microsoft::WRL::ComPtr<IDWriteTextFormat> mTextFormat;		// 文本格式
