...
protected:
	...
	// Direct2D
	Microsoft::WRL::ComPtr<ID2D1Factory> md2dFactory;					// D2D工厂
	Microsoft::WRL::ComPtr<ID2D1RenderTarget> md2dRenderTarget;			// D2D渲染目标
	Microsoft::WRL::ComPtr<IDWriteFactory> mdwriteFactory;				// DWrite工厂
	// Direct3D 11
