...
public:
    ...
    static ComPtr<ID3D11SamplerState> SSAnistropicWrap2x;               // 采样器状态：2倍各向异性过滤与Wrap模式
    static ComPtr<ID3D11SamplerState> SSAnistropicWrap4x;               // 采样器状态：4倍各向异性过滤与Wrap模式
    static ComPtr<ID3D11SamplerState> SSAnistropicWrap8x;               // 采样器状态：8倍各向异性过滤与Wrap模式
