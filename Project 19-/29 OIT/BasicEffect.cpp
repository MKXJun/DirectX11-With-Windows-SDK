    ...
    uint32_t renderTargetWidth)
{
    ...
    pImpl->m_pEffectHelper->SetUnorderedAccessByName("g_FLBufferRW", flBuffer, 0);
    pImpl->m_pEffectHelper->SetUnorderedAccessByName("g_StartOffsetBufferRW", startOffsetBuffer, 0);
