...
void SSAOManager::Begin(ID3D11DeviceContext* deviceContext, SSAOEffect& ssaoEffect, ID3D11DepthStencilView* dsv, const D3D11_VIEWPORT& vp, bool enableAlphaClip)
{
    ...
    ssaoEffect.SetRenderNormalDepthMap(deviceContext, enableAlphaClip);
}
