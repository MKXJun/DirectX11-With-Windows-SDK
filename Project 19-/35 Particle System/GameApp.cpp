...
bool GameApp::InitResource()
{
    ...
    // 天空盒
    {
        ...
        m_TextureManager.CreateFromFile("..\\Texture\\grasscube1024.dds", TextureManager::LoadConfig_ForceSRGB);
    ...
    // 初始化粒子系统
    //
    m_TextureManager.CreateFromFile("..\\Texture\\flare0.dds", TextureManager::LoadConfig_ForceSRGB);
    m_TextureManager.CreateFromFile("..\\Texture\\raindrop.dds", TextureManager::LoadConfig_ForceSRGB);
