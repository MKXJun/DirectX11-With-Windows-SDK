...
#pragma region IMGUI
    ...
    if (ImGui::Begin("Physically Based Rendering"))
    {
...
bool GameApp::InitResource()
{
    ...
    viewerCamera->SetViewPort(0.0f, 0.0f, (float)m_ClientWidth, (float)m_ClientHeight);
    viewerCamera->SetFrustum(XM_PI / 3, AspectRatio(), 0.5f, 300.0f);
    viewerCamera->LookAt(XMFLOAT3(-60.0f, 10.0f, 2.5f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));
    ...
    // 初始化对象
    //
    m_Sponza.SetModel(m_ModelManager.CreateFromFile("..\\Model\\SponzaPBR\\sponza.gltf"));
    ...
    m_ForwardEffect.SetDirectionalLights(4, lightDirs, lightColors);
